...
pre-change 没有结构化成果 manifest 时，按本节人工判断。v3.4 post-change 优先读取 authoritative `visible_output_realizations`、signature 层级、presentation blueprint 和 report-anchored judgments，但仍由人工复核正文与结构稿；为保持基线可比，历史稳定键名称不改。
