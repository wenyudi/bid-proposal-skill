...
| Task 2.5 | value-selection brief + 品味参考 | 一页纸策略、lead/supporting/reserve、Section spine、Claim/Action/visible output | `task2.5` 的窄权限 | research-informed；不自批 Gate/策略，不扩 authority |
