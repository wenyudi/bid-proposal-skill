...
| `task2.5` | 仅可写 customer value、delivery 和 strategy 的选择/编排范围，并受语义与 authority 冻结规则限制 |
| `task3`、`task3.5`、`redteam` | 无 canonical 写权限 |

Task 2.5 不能删除 canonical 历史、改客户语义集合、改 narrative / Big Idea / decision map、创建新 VP 核心语义、自批 Gate、增加 authority 或提升 committed / confirmed。
