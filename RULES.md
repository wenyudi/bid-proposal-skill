...
- Task 2.5 可在既有 Need/VP/Claim/Action 与 Evidence 边界内更新 one-page strategy、Big Idea、win themes、narrative、Section strategy role 和选择状态；Role/Need/Criterion/decision_paths/EvidenceLink 与 title/bid type/budget strategy/decision map 只读，不得新建/改写 VP 核心语义，不得 resolved/assumed Gate 或自批策略，不得新增/改变 authority、升 committed/confirmed，或扩大已授权语义。
...
- `strategy/v5` 的一页纸至少写清：客户张力、尖锐洞察及其非共识理由、核心命题与十秒记忆句、明确取舍、洞察→策略→表达→执行→证明、名称互换测试、proof plan、落地可信度和五维 ordinal 自评。政府/公共与商业模板分开；hybrid 必须声明主标准。
